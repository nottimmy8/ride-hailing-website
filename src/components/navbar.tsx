  ...
  <div className="flex flex-col sm:flex-row gap-3 pt-6 border-t border-gray-100">
    ...
    >
      ...
      <div className="text-left">
        ...
        <p className="text-white font-bold font-display text-sm leading-tight">
          {t.app_store}
        </p>
      </div>
    </a>
...
const Navbar = () => {
  ...
  const getTabContent = () => ({
    Ride: {
      ...
      showAppButtons: true,
      links: [
        { text: t.tab_ride_link1, href: "/ride" },
        { text: t.tab_ride_link2, href: "/ride" },
        { text: t.tab_ride_link3, href: "/ride" },
      ],
    },
    Drive: {
                ...
                {navLinks.map((item, i) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <span
                          className={`text-2xl font-display font-black transition-colors ${isExpanded ? "text-primary" : "text-gray-800"}`}
                        >
                        ...
                        >
                          <ChevronDown
                            className={`w-5 h-5 transition-colors ${isExpanded ? "text-primary" : "text-gray-400"}`}
                          />
                        </motion.div>
                      </button>
                          ...
                          >
                            <div className="pb-6 flex flex-col gap-4">
                              ...
                              <div className="flex flex-col gap-3">
                                {tabContent[item].links.map(
                                  (link: any, idx: number) => (
                                    /* 3. Replaced <a> with <Link> in Mobile */
                                    <Link
                                      key={idx}
                                      to={link.href}
                                      onClick={handleClose}
                              ...
                              {tabContent[item].showAppButtons && (
                                <AppButtons t={t} />
                              )}
                            </div>
                          </motion.div>
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-3 mb-10">
                      {tabContent[activeTab].links.map(
                        (link: any, idx: number) => (
                          /* 4. Replaced <a> with <Link> in Desktop */
                          <Link
                            key={idx}
                            to={link.href}
                            onClick={handleClose}
